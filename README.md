...
### **Frontend**
- **React 18** + **Next.js 14/15** - Performance e SEO
- **TypeScript** - Código robusto e escalável
- **TailwindCSS** - Design moderno e responsivo
- **Framer Motion** - Animações fluidas e profissionais

### **Backend**
- **Node.js** + **Express/Fastify** - APIs rápidas e eficientes
- **NestJS** - Arquitetura limpa e escalável
...
- Gestão de participantes e credenciais
- Integração com sistemas de pagamento
- Dashboard administrativo em tempo real

### **API de Alto Performance**
...
*"O sucesso não é acidental. É uma escolha, um hábito, uma decisão diária de fazer o que é necessário para alcançar seus objetivos."*

**— Marcos Felippe, Fullstack Developer**

---

<div align="center">

**⭐ Se este portfolio te ajudou, deixe uma estrela no GitHub!**

[![GitHub stars](https://img.shields.io/github/stars/mfelipperd/portfolio-marcos?style=social)](https://github.com/mfelipperd/portfolio-marcos)
